...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2023 a las 17:30:00
...
CREATE TABLE `menu` (
  ...
  `Elaborado` timestamp NOT NULL DEFAULT current_timestamp(),
  `Vencimiento` date DEFAULT NULL,
  `Tamanio` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `pri_reg`
--

CREATE TABLE `pri_reg` (
  `Cel` int(9) NOT NULL,
...
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`ID_Cliente`) REFERENCES `cliente` (`ID_Cliente`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `normal`
  ADD CONSTRAINT `fk112` FOREIGN KEY (`ID_Cliente`) REFERENCES `cliente` (`ID_Cliente`);
